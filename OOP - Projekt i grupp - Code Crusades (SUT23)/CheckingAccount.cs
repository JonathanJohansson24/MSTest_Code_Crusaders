...
namespace OOP___Projekt_i_grupp___Code_Crusades__SUT23_
{
    public class CheckingAccount : Accounts
    {
        ...
        //TESTMETOD 
        public static CheckingAccount CreateAccount(string name, decimal balance, string currency)
        {
            if (string.IsNullOrEmpty(name))
            {
                name = "Checking Account"; // Standard namn ifall man inte matar in något namn
            }
            ...
            {
                throw new ArgumentException("Ogiltig valuta.");
            }

            var account = new CheckingAccount(name, balance, currency);
